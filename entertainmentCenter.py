...
""" Movie class takes in (Title, Description, Movie Poster/Image Link,
YouTube Trailer Link, and Runtime) """
...
lost_children = media.Movie(
    ...
    "https://upload.wikimedia.org/wikipedia/en/4/40/City_of_lost_children_french_movie_poster.jpg",  # noqa
