...
# movie_title, movie_storyline, poster_image, trailer_youtube; show_trailer
...
zero_theorem = media.Movie("The Zero Theorem",
						   "A reclusive computer genius working on a formula to determine whether life holds any meaning.",
						   "http://ia.media-imdb.com/images/M/MV5BMTc4NTIxMTE0OF5BMl5BanBnXkFtZTgwNTQ5NTYxMjE@._V1_SX640_SY720_.jpg",
						   "https://www.youtube.com/watch?v=RyMSRRNHRos&feature=iv&src_vid=rae7_O_6EtU&annotation_id=annotation_1853691763",
						   "1h 47m")

lost_children = media.Movie("The City of Lost Children",
...
dreams_may_come = media.Movie("What Dreams May Come",
...
neverending_story_ii = media.Movie("The NeverEnding Story II: The Next Chapter",
								   "A young boy with a distant father enters a world of make-believe and magic through a portal within an antique book.",
								   "https://upload.wikimedia.org/wikipedia/en/8/87/Neverending_story_two_poster.jpg",
								   "https://www.youtube.com/watch?v=Gg3pSz-P7IE",
								   "1h 30m")

hook = media.Movie("Hook",
					"What if Peter Pan grew up?",
					"http://ia.media-imdb.com/images/M/MV5BMTU2MzYzOTQyMF5BMl5BanBnXkFtZTcwNDM2NDU2MQ@@._V1_SX640_SY720_.jpg",
